...
if (empty($id)) {
  $newid = sqlInsert("INSERT INTO form_init_clinical_assessment SET $sets");
  addForm($encounter, "Initial Clinical Assessment", $newid, "init_clinical_assessment", $pid, $userauthorized);
}
else {
  sqlStatement("UPDATE form_init_clinical_assessment SET $sets WHERE id = '". add_escape_custom("$id"). "'");
}
/*
[_SESSION] => Array
(
